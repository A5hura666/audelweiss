...
export default function ShopByCategory() {
    ...
    const subCategoryUrl = searchParams.get("product-type") || pathname.split("/").pop();
        ...
        const fetchHeaderData = async () => {
            try {
                const response = await fetch(
                    getStrapiCall(`/api/product-article-cards?filters[subCategory][$eq]=${subCategoryUrl}&populate=productImages`)
                );
