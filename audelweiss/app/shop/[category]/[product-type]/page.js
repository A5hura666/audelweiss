...
export default function ShopByCategory() {
    ...
    const subCategoryUrl =
        searchParams.get("product-type") || pathname.split("/").pop();
        ...
        const fetchHeaderData = async () => {
            try {
                const response = await fetch(
                    getStrapiCall(
                        `/api/product-article-cards?filters[subCategory][$eq]=${subCategoryUrl}&populate=productImages`
                    )
                );
        ...
        <div>
          ...
          <Breadcrumbs></Breadcrumbs>
            ...
            >
                                        ...
                                        >
                                            ...
                                            {isCategoryOpenD ? (
                                                ...
                                                <svg
                                                    ...
                                                    strokeLinejoin="round"
                                                    className={
                                                        "lucide lucide-chevron-up-icon lucide-chevron-down"
                                                    }
                                                >
                                                    <path d="m6 9 6 6 6-6"/>
                                                </svg>
                                                ...
                                                {[...subCategories].map((sub) => (
                                                    <li key={sub} className="pl-4 flex gap-2">
                                                        <input
                                                            ...
                                                            onChange={() =>
                                                                handleSubCategoryChange(category, sub, [
                                                                    ...subCategories,
                                                                ])
                                                            }
                                                            className="w-6 h-6 accent-[#E8A499] border-[#E8A499] rounded-md"
                ...
                >
                    {isLoaded && allProducts.length === 0 ? (
                        <div className="col-span-full text-center text-gray-500 text-lg w-[100%]">
